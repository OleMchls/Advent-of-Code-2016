defmodule Mix.Tasks.AdventOfCode do
  ...
  @shortdoc "Execute helper for Advent of Code challenges"

  def run([day | _rest]) do
    execute_day(String.to_integer(day))
    |> IO.inspect
  end

  def run([]), do: IO.warn "Add a day number to execute 'mix advent_of_code 1'"

  defp execute_day(1) do
    ...
    |> Aoc.DayOne.first_duplicate_distance
  end
